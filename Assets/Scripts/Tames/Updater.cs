    ...
    public class Updater
    {
        ...
        public Updater(TameThing owner, ushort b)
        {
            ...
            switch (b)
            {
                ...
                case TrackBasis.Distance:
                    if (owner.name == "distance") Debug.Log("cus: updater");
                    isDistance = true;
        ...
        public int Directable()
        {
            switch (sourceType)
            {
                case TrackBasis.Alter:
                    TameAlternative ta = (TameAlternative)source;
                    if (ta.qMarker.name == "material (1)")
                        if (ta.TotalIndex() > ta.LastTotalIndex())
                            Debug.Log("cahed: ");
               ...
               //     if (!tie.holdable)                        Debug.Log("cahed: ");
        ...
        public static Updater FromControlMarker(TameThing owner, QControl mc, InputSetting.ControlType ct)
        {
            switch (mc.mode)
            {
